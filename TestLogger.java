...
public class TestLogger {
    // Since you typically use one logger per class, we can make it a static field of
    // the TestLogger class.
    private static Logger theLogger = Logger.getLogger(TestLogger.class.getName());
    ...
    public static void main(String [] args) {
		if (args.length != 3){
			System.err.println("Usage TestLogger <input file> <output file>");
			System.exit(-1);
		}
        ...
        referencePileupLink.append("#reference_pileup_path");
        referencePileupLink.toString();
        
        System.err.println("Link:" + referencePileupLink);
        
        // Using the 'least important' type of message, one at the 'finest' level.
