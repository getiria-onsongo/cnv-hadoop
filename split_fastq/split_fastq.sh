...
forward_reads="${SampleName}_forwards_reads.txt"
reverse_reads="${SampleName}_reverse_reads.txt"
...
echo -e "${SampleName}_${fileNumber}\t${SampleName}_${fileNumber}_R1.fastq">> $forward_reads
...
echo -e "${SampleName}_${fileNumber}_R2.fastq">> $reverse_reads
